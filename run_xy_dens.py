...
mod.dens_contour(x, y, 200, xmin, xmax, ymin, ymax, ax = ax1, levels=levels)
...
mod.dens_contour(x, y, 200, xmin, xmax, ymin, ymax, ax = ax2, levels=levels)
ax2.set_xlabel('x',fontsize=18)
ax2.set_ylabel('y',fontsize=18)
ax2.set_title('$\Delta E_{J}$',fontsize=20)
#plt.colorbar(gci)
mod.plot_r('bar', ax2)
fig1.savefig('./output/xy_dens_t%3.3d_%3.3d_color.png'%(nn,(nn+dn)))
...
#plt.colorbar(gci)
mod.plot_r('bar', ax2)
fig2.savefig('./output/xy_dens_t%3.3d_%3.3d_small_color.png'%(nn,(nn+dn)))
