...
ymin = -8
ymax = 8
mod.hist2d_plot(x, y, nbins, xmin, xmax, ymin, ymax, ax=ax3)
ax3.set_xlabel('x',fontsize=18)
ax3.set_ylabel('y',fontsize=18)
ax3.set_title('$Density$',fontsize=20)
fig1.savefig('./output/xy_h2d_t%3.3d_%3.3d_color.png'%(nn,(nn+dn)))
...
fig2.savefig('./output/xy_h2d_t%3.3d_%3.3d_small_color.png'%(nn,(nn+dn)))
